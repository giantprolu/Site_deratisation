      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-nature-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <p className="text-lg text-nature-gray-600 mb-6 leading-relaxed">
                <strong className="text-eco-green-700">HygièneProtect3D</strong> est votre partenaire de confiance pour des solutions complètes d'hygiène et de désinsectisation.
                Basés à Bondy, nous intervenons rapidement et efficacement à travers toute l'Île-de-France, l'Est et
                ...
                {[
                  ...
                  return (
                    <div key={index} className="flex items-center gap-3 group">
                      <div className="flex-shrink-0 w-10 h-10 bg-eco-green-100 rounded-lg flex items-center justify-center group-hover:bg-eco-green-600 transition-colors duration-300">
                        <IconComponent className="h-5 w-5 text-eco-green-600 group-hover:text-white transition-colors duration-300" />
                      </div>
                      <span className="text-nature-gray-700 font-medium">{item.text}</span>
                    </div>
                  );
                })}
              </div>
          ...
          <div className="bg-gradient-to-br from-eco-green-50 to-eco-green-100 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-nature-gray-900 mb-2">Zone d'intervention</h3>
                <p className="text-nature-gray-600">
                  Île-de-France, Est et Nord de la France
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-eco-green-600 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="text-xl font-bold text-nature-gray-900 mb-2">Certifications</h3>
                <p className="text-nature-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-nature-gray-900 mb-2">Clients satisfaits</h3>
                <p className="text-nature-gray-600">
